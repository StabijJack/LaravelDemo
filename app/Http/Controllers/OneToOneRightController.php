...
class OneToOneRightController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('databaserelations/onetoone.right.index',compact('oneToOneRights'));
    }
    ...
    public function create()
    {
        ...
        return view('databaserelations/onetoone.right.create', compact('oneToOneRight'));
    }
    ...
    public function show(OneToOneRight $oneToOneRight)
    {
        ...
        return view('databaserelations/onetoone.right.show', compact('oneToOneRight','oneToOneLeft'));
    }
    ...
    {
        return view('databaserelations/onetoone.right.edit', compact('oneToOneRight'));
    }
